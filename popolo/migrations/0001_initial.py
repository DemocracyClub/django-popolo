    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dissolution_date', models.CharField(blank=True, help_text='A date of dissolution', max_length=10, verbose_name='dissolution date', validators=[django.core.validators.RegexValidator(regex=r'^[0-9]{4}(-[0-9]{2}){0,2}$', message=b'dissolution date must follow the given pattern: ^[0-9]{4}(-[0-9]{2}){0,2}$', code=b'invalid_dissolution_date')])),
                ('founding_date', models.CharField(blank=True, help_text='A date of founding', max_length=10, verbose_name='founding date', validators=[django.core.validators.RegexValidator(regex=r'^[0-9]{4}(-[0-9]{2}){0,2}$', message=b'founding date must follow the given pattern: ^[0-9]{4}(-[0-9]{2}){0,2}$', code=b'invalid_founding_date')])),
